...
Run examples::
    ...
    pytest tests/test_e2e.py -k "Tier1" -v

    # Tier 1-2
    pytest tests/test_e2e.py -k "Tier1 or Tier2" -v
...
Environment variables::
    ...
    PENTAGI_MODEL_NAME      — Model for Tier 1-2 (default: ds-v4-pro)
    PENTAGI_TIER3_MODEL     — Model for Tier 3 (default: ds-v4-pro)
    PENTAGI_TIER4_MODEL     — Model for Tier 4 (default: ds-v4-pro)
...
def _make_config(target_address: str, **overrides):
    ...
    defaults = dict(
        ...
        model_name=os.getenv("PENTAGI_MODEL_NAME", "ds-v4-pro"),
...
class TestTier3VulnDiscovery:
    ...
    def test_vuln_discovery_dvwa(self, target_dvwa):
        ...
        config = _make_config(
            target_dvwa["address"],
            model_name=os.getenv("PENTAGI_TIER3_MODEL", "ds-v4-pro"),
            max_subtasks=5,
...
class TestTier4Exploitation:
    ...
    def test_sqli_exploit_dvwa(self, target_dvwa):
        ...
        config = _make_config(
            target_dvwa["address"],
            model_name=os.getenv("PENTAGI_TIER4_MODEL", "ds-v4-pro"),
            max_subtasks=5,
